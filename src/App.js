    ...
    <div className="App">
      <header className="App-header">
        {isConnected() ? (
          <div>
            <p>
            <div className='img-logo'><img src="https://i.ibb.co/F5KbXf0/ticjk-sm-logo.png" alt="logo"/></div>
          ...
          <div>
            ...
            <p className='smmd'>
            The SIP term indicates Systematic Investment Plan, which means you can invest a fixed amount of money periodically without any market risk.
            <br/>It is a plan in which you can make equal payments to CRYPTO now and then without worrying about the market.
            </p>
          </div>
        )}
      </header>
